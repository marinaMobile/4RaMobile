...
class BRact : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_bract)
    ...
    private fun getUrl(): String {
        ...
        val cpOne: String? = Hawk.get(Constants.C1)
        val cpTwo: String? = Hawk.get(Constants.C2)
        val cpThree: String? = Hawk.get(Constants.C3)

        val dpOne: String? = Hawk.get(Constants.DL1)
        val dpTwo: String? = Hawk.get(Constants.DL2)
        val dpThree: String? = Hawk.get(Constants.DL3)



        val pack = "com.mobile4ra.a4ramobile"
        ...
        val first = "https://"
        val second = "4ramobile.fun/lZ3s1"
